...
Squirreltwo.create(user_id: User.all.sample.id, park_id: Park.all.sample.id, date: "10/12/2020", color: "cinnamon", running: true, chasing: true, climbing: true, eating: true, foraging: true, other_activities: "NA", kuk: false, quaas: true, wails: false, tail_flags: false, tail_twitches: false, approaches: false, indifferent: true, runs_from: false, other_interactions: "NA")
...
Squirreltwo.create(user_id: User.all.sample.id, park_id: Park.all.sample.id, date: "10/13/2020", color: "cinnamon", running: true, chasing: true, climbing: false, eating: false, foraging: true, other_activities: "eating hotdog", kuk: false, quaas: true, wails: false, tail_flags: false, tail_twitches: false, approaches: false, indifferent: true, runs_from: false, other_interactions: "NA")
...
Squirreltwo.create(user_id: User.all.sample.id, park_id: Park.all.sample.id, date: "10/15/2020", color: "cinnamon", running: false, chasing: true, climbing: true, eating: true, foraging: false, other_activities: "NA", kuk: true, quaas: false, wails: false, tail_flags: true, tail_twitches: true, approaches: false, indifferent: true, runs_from: false, other_interactions: "NA")
Squirreltwo.create(user_id: User.all.sample.id, park_id: Park.all.sample.id, date: "10/17/2020", color: "black", running: true, chasing: true, climbing: false, eating: false, foraging: true, other_activities: "NA", kuk: true, quaas: true, wails: true, tail_flags: false, tail_twitches: true, approaches: false, indifferent: false, runs_from: true, other_interactions: "NA")
